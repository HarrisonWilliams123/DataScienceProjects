...
df['MP'] = df['MP'].apply(lambda x: x * 40/36)
df['FG'] = df['FG'].apply(lambda x: x * 40/36)
df['FGA'] = df['FGA'].apply(lambda x: x * 40/36)
df['3P'] = df['3P'].apply(lambda x: x * 40/36)
df['3PA'] = df['3PA'].apply(lambda x: x * 40/36)
df['2P'] = df['2P'].apply(lambda x: x * 40/36)
df['2PA'] = df['2PA'].apply(lambda x: x * 40/36)
df['FT'] = df['FT'].apply(lambda x: x * 40/36)
df['FTA'] = df['FTA'].apply(lambda x: x * 40/36)
df['ORB'] = df['ORB'].apply(lambda x: x * 40/36)
df['DRB'] = df['DRB'].apply(lambda x: x * 40/36)
df['TRB'] = df['TRB'].apply(lambda x: x * 40/36)
df['AST'] = df['AST'].apply(lambda x: x * 40/36)
df['STL'] = df['STL'].apply(lambda x: x * 40/36)
df['BLK'] = df['BLK'].apply(lambda x: x * 40/36)
df['TOV'] = df['TOV'].apply(lambda x: x * 40/36)
df['PF'] = df['PF'].apply(lambda x: x * 40/36)
df['PTS'] = df['PTS'].apply(lambda x: x * 40/36)
